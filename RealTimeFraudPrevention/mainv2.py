...
def create_table_input(table_name, stream_name, broker, api_key, api_secret):
    return """ CREATE TABLE {0} (
            ...
            ) """.format(table_name, stream_name, broker, api_key, api_secret)

# Input outcome topic

def create_table_output_kafka(table_name, stream_name, broker, api_key, api_secret):
    return """ CREATE TABLE {0} (
                `transaction_amt` BIGINT NOT NULL,
                `email_address` VARCHAR(64) NOT NULL,
                `ip_address` VARCHAR(64) NOT NULL,
...
def main():
    ...
    api_key = "MS2I4TLRV5FZZ2ES" 
    api_secret = "wXCTPBGO+e9ttuPOXz9ClUhGx1co90yT/ttX+ZpbSEz3sWiGJwGqIgjpw3Ga2Cnu"
...
# Create input and output table
    table_env.execute_sql(create_table_input(input_table, input_stream, broker, api_key, api_secret))
    table_env.execute_sql(create_table_output_kafka(output_table_msk, output_stream_msk, broker, api_key, api_secret))
